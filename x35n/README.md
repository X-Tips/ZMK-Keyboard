X.Tips X35n Keyboard

Keyboard Maintainer: X.Tips

URL: www.umux.com

电池开关在键盘底面，充电或使用蓝牙模式时，拨到小孔位置打开电源。（默认不含电池，可选加，电池规格902030）。
...
Batteries are not included by default but can be optionally added. The battery specification is 902030.
