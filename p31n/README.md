...
采用**ZMK固件**、proMicro **nrf52840模块**设计，全键可编程，改键需要使用者自己掌握修改与编译代码的知识。
...
**ZMK** firmware and proMicro **nrf52840**coreboard design, providing source code: https://github.com/X-Tips/ZMK-Keyboard
